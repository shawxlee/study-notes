...
font-size | `1rem`  `1.25rem`(lg/lead/blockquote/navbar-brand/navbar-toggler)  `.875rem`(sm)  `6rem`(display1)  `5.5rem`(display2)  `4.5rem`(display3)  `3.5rem`(display4)  `80%`(small/blockquote-small)
font-weight | `400`  `700`(bold/dt/nested-kbd/alert-link)  `500`(headings)  `300`(display/lead)
height | `2.5rem`(nav-link)  `1.875rem`(navbar-brand)
line-height | `1.5`  `1.2`(headings/display)
margin | `.255em`(caret)  `.5rem`(headings-margin-bottom/nav-divider-margin-y)  `1rem`(hr-margin-y)
padding | `.255em`(caret)  `.2em`(mark)  `.5rem`(list-inline/nav-link-padding-y/navbar-nav-link-padding-x/navbar-padding-y)  `1rem`(nav-link-padding-x/navbar-padding-x)  `.3125rem`(navbar-brand-padding-y)  `.25rem`(navbar-toggler-padding-y)  `.75rem`(navbar-toggler-padding-x)
