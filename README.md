...
font-size | `1rem`(base/input-btn/btn)  `1.25rem`(lg/lead/blockquote/navbar-brand/navbar-toggler/input-btn-lg/btn-lg)  `.875rem`(sm/input-btn-sm/btn-sm)  `6rem`(display1)  `5.5rem`(display2)  `4.5rem`(display3)  `3.5rem`(display4)  `80%`(small/blockquote-small)
font-weight | `400`(base/btn)  `700`(bold/dt/nested-kbd/alert-link)  `500`(headings)  `300`(display/lead)
height | `2.5rem`(nav-link)  `1.875rem`(navbar-brand)
line-height | `1.5`(base/lg/sm/input-btn/input-btn-sm/input-btn-lg/btn/btn-sm/btn-lg)  `1.2`(headings/display)
margin | `.255em`(caret)  `.5rem`(headings-margin-bottom/nav-divider-margin-y/btn-block-margin-y)  `1rem`(hr-margin-y)
opacity | `.65`(btn-disabled)
padding | `.255em`(caret)  `.2em`(mark)  `.5rem`(list-inline/nav-link-padding-y/navbar-nav-link-padding-x/navbar-padding-y/input-btn-padding-x-sm/input-btn-padding-y-lg/btn-padding-x-sm/btn-padding-y-lg/btn-block-padding-y)  `1rem`(nav-link-padding-x/navbar-padding-x/input-btn-padding-x-lg/btn-padding-x-lg)  `.3125rem`(navbar-brand-padding-y)  `.25rem`(navbar-toggler-padding-y/input-btn-padding-y-sm/btn-padding-y-sm)  `.75rem`(navbar-toggler-padding-x/input-btn-padding-x/btn-padding-x)  `.375rem`(input-btn-padding-y/btn-padding-y)
